...
<!--<a href="javascript:;" onclick="shua()" class="btn btn-secondary-outline radius" data-title="刷新数据"><i class="Hui-iconfont">&#xe68f;</i>刷新数据</a>-->
	...
	<div class="text-c">
	 ...
	 <span class="select-box inline"></span> 日期范围：
		<input type="text" onfocus="WdatePicker({ maxDate:'#F{$dp.$D(\'logmin\')||\'%y-%M-%d\'}' })" id="logmin" class="input-text Wdate" style="width:120px;">
		-
		<input type="text" onfocus="WdatePicker({ minDate:'#F{$dp.$D(\'logmax\')}',maxDate:'%y-%M-%d' })" id="logmax" class="input-text Wdate" style="width:120px;">
...
<script type="text/javascript">
	...
	var t = $('#example').DataTable({
		...
		bLengthChange: false,
		autoWidth: true,
		columns: [{"data": null}, {"data": "group"}, {"data": "jump"}, {"data": "domain"}, {"data": "view"},{"data": "timeline"}, {"data": "sharelu"}, {"data": "share"}, {"data": "shareend"}, {"data": "download"}, {"data": "sharebl"}, {"data": "shareb"}, {"data": "shareendb"}, {"data": "downb"}],
		"columnDefs": [
//			{
...
//			},
	...
	$("#tj").click(function(){
		var t1=$("#logmin").val();
		var t2=$("#logmax").val()
		t.ajax.url("/index.php?c=Main&a=ApiWebList&t1=" + t1+"&t2="+t2).load();
